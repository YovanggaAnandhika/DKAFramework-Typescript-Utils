...
export interface estimationCostFromTimeInterfaceSettings {
    minutes ?: estimationCostFromTimeInterfaceSettingsParameter,
    hours ?: estimationCostFromTimeInterfaceSettingsParameter,
    day ?: estimationCostFromTimeInterfaceSettingsParameter
}
